---
title: "Рекомендации по обеспечению высокой доступности и аварийному восстановлению для среды бастиона | Microsoft Identity Manager"
description: 
keywords: 
author: kgremban
manager: femila
...
| --------------------------- | --------------------- | -------------- |
| Установление доверия         | Низкий | Дождитесь восстановления среды бастиона |
| Перенос пользователей и групп   | Низкий | Дождитесь восстановления среды бастиона |
...
| Управление ресурсами         | высоко- | Выделенные резервные учетные записи со смарт-картами, позволяющие добавить пользователей в административные группы вручную |
| Наблюдение за пользователями и группами в существующем лесу | Низкий | Дождитесь восстановления среды бастиона |
