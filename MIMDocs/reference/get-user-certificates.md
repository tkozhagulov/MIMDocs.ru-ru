---
title: "Получение сертификатов пользователей | Документация Майкрософт"
description: 
keywords: 
author: msmbaldwin
ms.author: mbaldwin
...
---
# <a name="get-user-certificates"></a>Получение сертификатов пользователей
Получает список сертификатов, связанных с указанным пользователем (устаревшие сертификаты фильтруются).
...
В случае успешного выполнения возвращает список JSON-сериализованных объектов [Microsoft.Clm.Shared.Certificates.X509ClmCertificate](https://msdn.microsoft.com/library/microsoft.clm.shared.certificates.x509clmcertificate(v=vs.100).aspx) со следующими свойствами:
...
Издатель | Издатель.
NotAfter | Дата и время окончания срока действия сертификата.
NotBefore | Дата и время начала срока действия сертификата.
ЗапросerНазвание | Учетная запись, запросившая сертификат.
SerialNumber | Серийный номер сертификата.
состояние; | Состояние сертификата.
TemplateCommonНазвание | Общее имя шаблона сертификата.
