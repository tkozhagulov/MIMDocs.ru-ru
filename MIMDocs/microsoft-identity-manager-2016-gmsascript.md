...
Обновление пароля для хранимых учетных записей с помощью PowerShell, чтобы клиентам не нужно было включать режим изменений

Обновление учетной записи Office365 с помощью PowerShell:
