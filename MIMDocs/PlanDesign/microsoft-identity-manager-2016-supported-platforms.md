...
| | Exchange для подготовки почтовых ящиков и синхронизации GAL (необязательно)|Exchange Server 2007 с пакетом обновления 3 (SP3)<br/>Exchange Server 2010 с пакетом обновления 3 (SP3)<br/>Exchange Server 2013 с пакетом обновления 1 (SP1)<br/>Exchange Server 2016* |
...
| | Почтовый сервер (необязательно) | Exchange Server 2007 с пакетом обновления 3 (SP3)<br/>Exchange Server 2010 с пакетом обновления 3 (SP3)<br/>Exchange Server 2013 с пакетом обновления 1 (SP1) <br/> Exchange Server 2016 * |
