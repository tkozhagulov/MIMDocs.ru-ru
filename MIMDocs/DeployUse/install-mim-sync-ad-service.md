---
title: "Синхронизация AD и службы MIM | Документация Майкрософт"
...
2.  Чтобы открыть мастер создания агента управления, на странице **Действия управления** в меню **Действия** выберите команду **Создать**.
...
9.  На странице **Настройка потока атрибутов** создайте следующие сопоставления потока атрибутов и нажмите кнопку **Далее**.
    ...
    | Домен | Экспорт | домен |
    | Электронная почта | Экспорт | mail |
    | EmployeeID | Экспорт | employeeID |
    | EmployeeType | Экспорт | employeeType |
    | Имя | Экспорт | firstName |
    | Фамилия | Экспорт | lastName |
    ...
    | Участник | Экспорт | member |
    | ObjectSID | Экспортировать | objectSid |
    | Область | Экспорт | область действия |
    | Type | Экспорт | type |
    | УчастникshipAddWorkflow | Экспорт | membershipAddWorkflow |
    | УчастникshipLocked | Экспорт | membershipLocked |
