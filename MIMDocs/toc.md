...
## [Основные сведения об MIM 2016](/microsoft-identity-manager/understand-explore/microsoft-identity-manager-2016)
## [Новые возможности в пакете обновления 1](/microsoft-identity-manager/understand-explore/Microsoft-identity-manager-2016-sp1-release-notes)
### [Сценарии развертывания PAM в MIM 2016 SP1](/microsoft-identity-manager/understand-explore/sp1-deployment-scripts)
## [Гибридные отчеты в Azure](/microsoft-identity-manager/understand-explore/identity-manager-hybrid-reporting-azure)
# [Планирование и проектирование](/microsoft-identity-manager/plan-design/microsoft-identity-manager-2016-supported-platforms)
## [Поддерживаемые платформы](/microsoft-identity-manager/plan-design/microsoft-identity-manager-2016-supported-platforms)
## [Подключение к каталогам](/microsoft-identity-manager/plan-design/supported-management-agents)
## [Планирование загрузки](/microsoft-identity-manager/plan-design/capacity-planning-guide)
## [Топология развертывания](/microsoft-identity-manager/plan-design/topology-considerations)
# [Развертывание и использование](/microsoft-identity-manager/deploy-use/microsoft-identity-manager-deploy)
## [Первое развертывание](/microsoft-identity-manager/deploy-use/microsoft-identity-manager-deploy)
### [Настройка домена](/microsoft-identity-manager/deploy-use/preparing-domain)
### [Настройка сервера: Windows Server](/microsoft-identity-manager/deploy-use/prepare-server-ws2012r2)
### [Настройка сервера: SQL](/microsoft-identity-manager/deploy-use/prepare-server-sql2014)
### [Настройка сервера: SharePoint](/microsoft-identity-manager/deploy-use/prepare-server-sharepoint)
### [Настройка сервера: Exchange](/microsoft-identity-manager/deploy-use/prepare-server-exchange)
### [Установка MIM: синхронизация](/microsoft-identity-manager/deploy-use/install-mim-sync)
### [Установка службы и портала MIM](/microsoft-identity-manager/deploy-use/install-mim-service-portal)
### [Установка MIM: базы данных синхронизации](/microsoft-identity-manager/deploy-use/install-mim-sync-ad-service)
## [Обновление с Forefront Identity Manager 2010 R2](/microsoft-identity-manager/deploy-use/microsoft-identity-manager-2016-upgrade-from-fim-2010-R2)
## [Служба уведомлений о смене паролей](/microsoft-identity-manager/deploy-use/deploying-mim-password-change-notification-service-on-domain-controller)
## [Гибридные отчеты Identity Manager](/microsoft-identity-manager/deploy-use/working-with-identity-manager-hybrid-reporting)
## [Самостоятельный сброс пароля](/microsoft-identity-manager/deploy-use/working-with-self-service-password-reset)
## [Диспетчер сертификатов MIM](/microsoft-identity-manager/deploy-use/working-with-mim-certificate-manager)
### [Регистрация смарт-карт](/microsoft-identity-manager/deploy-use/certificate-manager-for-non-administrators)
### [Создание сертификатов программного обеспечения](/microsoft-identity-manager/deploy-use/certificate-manager-for-software-certificates)
...
## [Справочник разработчика Microsoft Identity Manager 2016](/microsoft-identity-manager/reference/microsoft-identity-manager-2016-developer-reference)
