...
ms.locfileid: "52825796"
---
# <a name="microsoft-identity-manager-data-handling"></a>Обработка данных Microsoft Identity Manager 

Эта статья дает организациям рекомендации по эффективному принятию решений при работе с множеством подключенных источников данных.  Для этого используются операции поиска, удаления, обновления и отчетности.  Прежде чем выбрать подход к удалению или обновлению, нужно обязательно проанализировать текущую схему и конфигурацию системы управления удостоверениями (MIM). 

Ниже приведены несколько сценариев, которые клиенты должны рассмотреть, и вопросы, на которые им нужно ответить: 
